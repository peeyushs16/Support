 ...
 * @see     https://pttimeselect.sourceforge.net
 * 
 * @requires jQuery {@link https://www.jquery.com}
 * 
 * 
 * LICENSE:
 * 
        ...
        jQuery(document).ready(
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    jQuery("body").append(
                            '<div id="ptTimeSelectCntr" class="" style="display: none;">'
                        ...
                        +    '                        class="ui-corner-all ui-state-default" style="color:#fff;padding: 0px; border: 0px none;">'
